...
//  }
  ...
  @Axiom("exp'", conclusion = "__(exp(f(g)))'__=(f(g))' · exp(f(g))", unifier = "linear",
    key = "0", recursor = "0")
  val Dexp = coreAxiom("exp' derive exp")
  @Axiom("sin'", conclusion = "__(sin(f(g)))'__=(f(g))' · cos(f(g))", unifier = "linear",
    key = "0", recursor = "0")
  val Dsin = coreAxiom("sin' derive sin")
  @Axiom("cos'", conclusion = "__(cos(f(g)))'__=(f(g))' · -sin(f(g))", unifier = "linear",
    key = "0", recursor = "0")
  val Dcos = coreAxiom("cos' derive cos")
  @Axiom("='", conclusion = "__(f(x)=g(x))'__↔f(x)'=g(x)'",
    key = "0", recursor = "0;1", unifier = "surjlinear")
